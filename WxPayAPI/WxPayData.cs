...
{
    partial class WxPayData
    {
        private readonly AppConfig _config = null;
        public WxPayData(string appid)
        {
            _config = AppConfigLibrary.Get(appid);
        }
        ...
        **/
        public string ToXml()
        {
            ...
            foreach (KeyValuePair<string, object> pair in m_values)
            {
                ...
                if (pair.Value == null)
                {
                    LogManager.Error(this.GetType().ToString(), "WxPayData字段" + pair.Key + "含有值为null的字段!");
